...
// User routes
router.post('/', (0, validate_middleware_1.validate)(booking_validator_1.createBookingSchema), bookingController.createBooking);
router.patch('/:id/status', (0, validate_middleware_1.validate)(booking_validator_1.updateStatusSchema), bookingController.updateStatus);
